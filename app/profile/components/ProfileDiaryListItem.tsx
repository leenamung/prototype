...
const ProfileDiaryListItem: React.FC<ProfileDiaryListItemProps> = ({ diary }) => {
  ...
  return (
    <div className="flex items-center p-4 border-b border-[var(--color-border)] cursor-pointer hover:bg-[var(--color-subtle-bg)] transition-colors duration-150">
      <div className={`w-1 h-12 ${emotionBarColorClass} rounded-full mr-4 flex-shrink-0`}></div>
