...
const TextEditorTab: React.FC<TextEditorTabProps> = ({ content, onContentChange, placeholder }) => {
  return (
    <div className="bg-[var(--color-component-bg)] rounded-lg shadow-sm p-4 border border-[var(--color-border)]"> 
      <textarea
        className="w-full min-h-[250px] bg-[var(--color-subtle-bg)] p-3 rounded-lg border-none focus:ring-1 focus:ring-[var(--color-primary)] outline-none text-[var(--text-main)] text-sm leading-relaxed resize-none placeholder:text-[var(--text-subtle)]/70"
