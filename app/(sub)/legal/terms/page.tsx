...
const TermsPage = () => {
  return (
    <LegalPageLayout title="이용약관" effectiveDate="2025년 9월 25일">
      <section>
        <h3 className="text-base font-bold mb-2">제 1조 (목적)</h3>
        <p>
          본 약관은 '하루의 조각'(이하 '서비스')의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
        </p>
      </section>
      <section>
        <h3 className="text-base font-bold mb-2">제 2조 (정의)</h3>
        <p>
          1. "서비스"란 구현되는 단말기와 상관없이 회원이 이용할 수 있는 하루의 조각 및 관련 제반 서비스를 의미합니다.<br/>
