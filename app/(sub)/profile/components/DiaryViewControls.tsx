...
const DiaryViewControls: React.FC<DiaryViewControlsProps> = ({ currentView, onViewChange, onFilterToggle, hasActiveFilters }) => {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2 border-b border-[var(--color-border)] bg-[var(--color-component-bg)] sticky top-[calc(theme(spacing.14)+theme(spacing.12))_-_1px] z-10">
