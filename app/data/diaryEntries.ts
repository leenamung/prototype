...
export const diaryEntriesData: DiaryEntry[] = [
  ...
  },
  {
    ...
    title: "아침의 생각들",
    content: "오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...오늘 아침에 일어나서 생각한 것들을 녹음해봤어요. 가끔은 글로 쓰는 것보다 말로 표현하는 게 더 편할 때가 있더라고요...",
    likes: 18,
    comments: 5,
    type: 'audio',
    audioInfo: {
