...
const AgitHeader: React.FC<AgitHeaderProps> = ({ coverImage, name, memberCount, onWritePostClick, onInviteMemberClick }) => {
  return (
    <div className="relative border-b border-[var(--color-border)]">
      ...
      <div className="p-4 bg-[var(--color-component-bg)]">
        ...
        <div className="flex mt-4 space-x-2">
          <button
            ...
            className="bg-[var(--color-primary)] text-[var(--text-on-primary)] px-4 py-2 rounded-[var(--rounded-button)] flex items-center cursor-pointer text-sm font-medium hover:opacity-90 transition-opacity border border-[var(--color-primary-dark)]"
          >
          ...
          <button
            ...
            className="bg-[var(--color-component-bg)] border border-[var(--color-border)] px-4 py-2 rounded-[var(--rounded-button)] flex items-center cursor-pointer text-sm font-medium text-[var(--text-subtle)] hover:border-[var(--color-primary-dark)] transition-all"
          >
