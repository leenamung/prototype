...
export default function SignUpClientPage() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-3.5rem)] p-5"> {/* 헤더 높이만큼 뺀 최소 높이 */}
      <motion.main 
        ...
        <div className="mt-8 pt-4 border-t border-[var(--color-border)]">
          ...
          <div className="pl-7 space-y-2 text-sm text-[var(--text-subtle)]">
            <div className="flex items-center justify-between">
              ...
              <Link href="/legal/terms" className="text-xs hover:underline">보기</Link>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
              ...
              <Link href="/legal/privacy" className="text-xs hover:underline">보기</Link>
            </div>
          </div>
        </div>
      </motion.main>
