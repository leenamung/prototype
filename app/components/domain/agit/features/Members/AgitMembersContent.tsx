      ...
      <div className="bg-[var(--color-component-bg)] p-4 sticky top-[calc(theme(spacing.14)+theme(spacing.12)+1px)] z-10 border-b border-[var(--color-border)] shadow-sm">
        <div className="relative mb-4">
          <input
            ...
            className="w-full py-3 px-10 bg-[var(--color-subtle-bg)] rounded-full text-base text-[var(--text-main)] placeholder:text-[var(--text-subtle)]/80 focus:ring-2 focus:ring-[var(--color-primary)]/50 focus:border-[var(--color-primary-dark)] outline-none transition-all"
          />
