    ...
    <div className="relative w-full py-4">
      ...
      {canScrollLeft && (
        <button
          ...
          className="absolute left-0 z-10 w-8 h-8 my-auto transition-opacity duration-300 bg-white rounded-full shadow-md opacity-75 top-1/2 -translate-y-1/2 hover:opacity-100"
        >
          &lt;
        </button>
      )}
      ...
      {canScrollRight && (
        <button
          ...
          className="absolute right-0 z-10 w-8 h-8 my-auto transition-opacity duration-300 bg-white rounded-full shadow-md opacity-75 top-1/2 -translate-y-1/2 hover:opacity-100"
        >
          &gt;
        </button>
      )}
